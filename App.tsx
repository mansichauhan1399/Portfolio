  ...
  return (
    <section className="hero-section" aria-label="Associate Product Designer introduction">
      <svg className="hero-scene" viewBox="0 0 1432 805" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
        ...
        <g className="hero-house" transform="translate(230 219)">
        ...
        <g className="hero-svg-sun" transform="translate(1028 188)">
        ...
        <g className="hero-svg-flower" transform="translate(900 380)">
        ...
        <g className="hero-character" transform="translate(510 92)">
          <g className="hero-cat">
